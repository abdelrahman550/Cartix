  ...
  return (
    <>
      <div className="bg-white p-10 md:p-16">
        <div className="bg-[linear-gradient(135deg,#0F0810_0%,#1a0008_40%,#C8102E_100%)] relative z-10 overflow-hidden p-10 md:p-16 rounded-3xl shadow-white/50 shadow-xs">
        ...
        <div className="flex h-full justify-between flex-col lg:flex-row gap-8">
          ...
          <div className="z-30 basis-1/3 hidden md:block">
