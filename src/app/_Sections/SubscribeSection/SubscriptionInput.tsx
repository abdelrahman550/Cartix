  ...
  return (
    <div className="flex items-center gap-3 mb-3">
      <Input
        ...
        type="email"
      />
      <Button className="h-12 text-black bg-white cursor-pointer flex items-center gap-1 text-sm font-bold px-6 transition hover:bg-white/85 hover:-translate-y-0.5 crimson-shadow-hover group">
        <span>Subscribe</span>
