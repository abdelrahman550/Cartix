...
export default function LoadingCheckoutState() {
  return (
     <div className="h-125 flex items-center justify-center bg-white rounded-2xl px-10 py-20">
            ...
            <div className="flex flex-col justify-center items-center   ">
                ...
                <h3 className={`${fraunces.className} text-3xl font-bold mb-4`}>Loading Your Checkout...</h3>
                <span className="mb-6 text-sm text-gray-600">Preparing Your Order</span>
