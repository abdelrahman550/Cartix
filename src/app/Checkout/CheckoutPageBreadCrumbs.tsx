...
export default function CheckoutPageBreadCrumbs() {
  return (
    <div className="flex items-center gap-2 bg-gray-100 px-6 py-5 text-sm font-semibold text-gray-500 md:px-14">
      ...
      <Link href={"/Cart"} className="hover:text-crimson transition">
        Cart
      </Link>
      <span>
        <ChevronRight size={14} strokeWidth={3} />
      </span>
      <span className="text-crimson bg-crimson-mid/75 border-crimson max-w-80 truncate rounded-full border text-xs px-3 py-1 transition">
        Checkout
      </span>
    </div>
  );
