...
export default function LoginCardNav() {
  return (
    <div className="flex w-full">
          ...
          >
            ...
            <span className="bg-crimson-dark absolute right-full bottom-0 h-0.75 w-full transition group-hover:translate-x-full"></span>
          </Link>
        </div>
  )
}
